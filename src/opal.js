...
Opal.modules["corelib/constants"] = function(Opal) {
  ...
  Opal.const_set($nesting[0], 'RUBY_ENGINE_VERSION', "0.11.0");
  Opal.const_set($nesting[0], 'RUBY_RELEASE_DATE', "2017-12-08");
...
Opal.modules["corelib/string"] = function(Opal) {
  ...
  ;
    ...
    return (Opal.defn(self, '$unpack', TMP_String_unpack_70 = function $$unpack(format) {
      var self = this;
...
if (ivar == null) ivar = nil;
    ...
    Opal.const_get_relative($nesting, 'Opal').$pristine(self, "allocate", "copy_instance_variables", "initialize_dup");
    return (Opal.defn(self, '$pack', TMP_Array_pack_117 = function $$pack($a_rest) {
      var self = this, args;
    ...
    }, TMP_Array_pack_117.$$arity = -1), nil) && 'pack';
