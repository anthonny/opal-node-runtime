...
;
  ...
  (function($base, $parent_nesting) {
    ...
    var def = self.prototype, $nesting = [self].concat($parent_nesting), TMP_Kernel_freeze_20, TMP_Kernel_frozen$q_21;
  ...
  (function($base, $parent_nesting) {
    ...
    var def = self.prototype, $nesting = [self].concat($parent_nesting), TMP_Kernel_taint_22, TMP_Kernel_untaint_23, TMP_Kernel_tainted$q_24;
  ...
  (function($base, $super, $parent_nesting) {
    ...
    var def = self.prototype, $nesting = [self].concat($parent_nesting), TMP_Module_public_25, TMP_Module_private_class_method_26, TMP_Module_private_method_defined$q_27, TMP_Module_private_constant_28;
  ...
  (function($base, $parent_nesting) {
    ...
    var def = self.prototype, $nesting = [self].concat($parent_nesting), TMP_Kernel_private_methods_29;
  ...
  (function($base, $parent_nesting) {
    ...
    var def = self.prototype, $nesting = [self].concat($parent_nesting), TMP_Kernel_eval_30;
